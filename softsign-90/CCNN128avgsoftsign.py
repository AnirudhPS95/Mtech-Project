...
## Encoder
x = Conv2D(16, (3, 3), activation='softsign', padding='same')(input_img)
x = MaxPooling2D((2, 2), padding='same')(x)                             #(64,64)
x = Conv2D(8, (3, 3), activation='softsign', padding='same')(x)
x = MaxPooling2D((2, 2), padding='same')(x)                             #(32,32)
x = Conv2D(8, (3, 3), activation='softsign', padding='same')(x)
x = MaxPooling2D((2, 2), padding='same')(x)                             #(16,16)
x = Conv2D(8, (3, 3), activation='softsign', padding='same')(x)
x = MaxPooling2D((2, 2), padding='same')(x)                             #(8,8)
x = Conv2D(4, (3, 3), activation='softsign', padding='same')(x)
...
x1 = Dense(2*2*4,activation='softsign')(decoder_input)
x1 = Reshape([2,2,4])(x1)                                               #(2,2)
x1 = UpSampling2D((2,2))(x1)                                            #(4,4)                                        
x1 = Conv2D(4,(3,3),activation='softsign',padding='same')(x1)
x1 = UpSampling2D((2,2))(x1)                                            #(8,8)
x1 = Conv2D(8,(3,3),activation='softsign',padding='same')(x1)
x1 = UpSampling2D((2,2))(x1)                                            #(16,16)
x1 = Conv2D(8,(3,3),activation='softsign',padding='same')(x1)
x1 = UpSampling2D((2,2))(x1)                                            #(32,32)
x1 = Conv2D(8,(3,3),activation='softsign',padding='same')(x1)
x1 = UpSampling2D((2,2))(x1)                                            #(64,64)
x1 = Conv2D(16,(3,3),activation='softsign',padding='same')(x1)
...
log_csv=CSVLogger('2000epochssoftsign.csv',separator=',', append=False)
