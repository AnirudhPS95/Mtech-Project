...
x1 = Dense(2*2*4,activation='softmax')(decoder_input)
x1 = Reshape([2,2,4])(x1)                                               #(2,2)
x1 = UpSampling2D((2,2))(x1)                                            #(4,4)                                        
x1 = Conv2D(4,(3,3),activation='softmax',padding='same')(x1)
x1 = UpSampling2D((2,2))(x1)                                            #(8,8)
x1 = Conv2D(8,(3,3),activation='softmax',padding='same')(x1)
x1 = UpSampling2D((2,2))(x1)                                            #(16,16)
x1 = Conv2D(8,(3,3),activation='softmax',padding='same')(x1)
x1 = UpSampling2D((2,2))(x1)                                            #(32,32)
x1 = Conv2D(8,(3,3),activation='softmax',padding='same')(x1)
x1 = UpSampling2D((2,2))(x1)                                            #(64,64)
x1 = Conv2D(16,(3,3),activation='softmax',padding='same')(x1)
...
log_csv=CSVLogger('2000epochssoftmax.csv',separator=',', append=False)
